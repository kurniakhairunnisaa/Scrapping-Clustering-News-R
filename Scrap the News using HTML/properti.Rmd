...
ubah
```{r}
daftarpages <- c(ceiling(355/9)) #Jumlah pages
daftarurl <-c(
  'https://www.detik.com/search/searchall?query=properti&siteid=29&sortby=time&fromdatex=01/07/2018&todatex=31/12/2018&page=')
...
ubah
```{r}
beritaprop <-fetchberita(listurls)
```
ubah
```{R}
write.csv(beritaprop,'E:/Tugas Akhir/berita diambil/dataprop.csv')
beritadetik <- read.csv("E:/Tugas Akhir/berita diambil/dataprop.csv")
```
...
x <- data.frame(topik=rep("properti", nrow(beritadetik)))
beritadetik <- cbind(beritadetik,x)
beritadetik <- beritadetik[beritadetik$tahun>2017,]
```
ubah
```{R}
write.csv(beritadetik,'E:/Tugas Akhir/berita diambil/berita properti.csv')
```
ubah
```{r}
beritadetik <- read.csv("E:/Tugas Akhir/berita diambil/berita properti.csv")
...
write.csv(beritadetik1,'E:/Tugas Akhir/berita diambil/berita properti tri III.csv')
write.csv(beritadetik2,'E:/Tugas Akhir/berita diambil/berita properti tri IV.csv')
```