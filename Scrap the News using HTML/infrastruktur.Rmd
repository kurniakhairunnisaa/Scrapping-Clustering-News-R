...
ubah
```{r}
daftarpages <- c(ceiling(1264/9)) #Jumlah pages
daftarurl <-c(
  'https://www.detik.com/search/searchall?query=infrastruktur&siteid=29&sortby=time&fromdatex=01/07/2018&todatex=31/12/2018&page=')
...
ubah
```{r}
beritainf <-fetchberita(listurls)
```
ubah
```{R}
write.csv(beritainf,'E:/Tugas Akhir/berita diambil/datainf.csv')
beritadetik <- read.csv("E:/Tugas Akhir/berita diambil/datainf.csv")
```
...
x <- data.frame(topik=rep("infrastruktur", nrow(beritadetik)))
beritadetik <- cbind(beritadetik,x)
beritadetik <- beritadetik[beritadetik$tahun>2017,]
```
ubah
```{R}
write.csv(beritadetik,'E:/Tugas Akhir/berita diambil/berita infrastruktur.csv')
```
ubah
```{r}
beritadetik <- read.csv("E:/Tugas Akhir/berita diambil/berita infrastruktur.csv")
...
write.csv(beritadetik1,'E:/Tugas Akhir/berita diambil/berita infrastruktur tri III.csv')
write.csv(beritadetik2,'E:/Tugas Akhir/berita diambil/berita infrastruktur tri IV.csv')
```