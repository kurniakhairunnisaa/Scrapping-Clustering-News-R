...
ubah
```{r}
daftarpages <- c(ceiling(1864/9)) #Jumlah pages
daftarurl <-c(
  'https://www.detik.com/search/searchall?query=industri&siteid=29&sortby=time&fromdatex=01/07/2018&todatex=31/12/2018&page=')
...
ubah
```{r}
beritaind <-fetchberita(listurls)
```
ubah
```{R}
write.csv(beritaind,'E:/Tugas Akhir/berita diambil/dataind.csv')
beritadetik <- read.csv("E:/Tugas Akhir/berita diambil/dataind.csv")
```
...
x <- data.frame(topik=rep("industri", nrow(beritadetik)))
beritadetik <- cbind(beritadetik,x)
beritadetik <- beritadetik[beritadetik$tahun>2017,]
```
ubah
```{R}
write.csv(beritadetik,'E:/Tugas Akhir/berita diambil/berita industri.csv')
```
ubah
```{r}
beritadetik <- read.csv("E:/Tugas Akhir/berita diambil/berita industri.csv")
...
write.csv(beritadetik1,'E:/Tugas Akhir/berita diambil/berita industri tri III.csv')
write.csv(beritadetik2,'E:/Tugas Akhir/berita diambil/berita industri tri IV.csv')
```