...
```{r}
daftarpages <- c(ceiling(503/9),ceiling(143/9),ceiling(1)) #Jumlah pages
daftarurl <-c(
  'https://www.detik.com/search/searchall?query=moneter&siteid=29&sortby=time&fromdatex=01/01/2018&todatex=31/12/2018&page=',
  'https://www.detik.com/search/searchall?query=moneter&siteid=3&sortby=time&fromdatex=01/01/2018&todatex=31/12/2018&page=',
  'https://www.detik.com/search/searchall?query=moneter&siteid=5&sortby=time&fromdatex=01/01/2018&todatex=31/12/2018&page=')
...
```{r}
beritamoneter <-fetchberita(listurls)
```

```{R}
write.csv(beritamoneter,'E:/Tugas Akhir/Fetch Berita/datamoneter.csv')
beritadetik <- read.csv("E:/Tugas Akhir/Fetch Berita/datamoneter.csv")
```

nambah data
```{R}
write.csv(beritamoneter,'E:/Tugas Akhir/Fetch Berita/datamoneternew.csv')
beritadetik <- read.csv("E:/Tugas Akhir/Fetch Berita/datamoneternew.csv")
```
...
x <- data.frame(topik=rep("moneter", nrow(beritadetik)))
...
```{R}
write.csv(beritadetik,'E:/Tugas Akhir/Fetch Berita/berita moneter 2018.csv')
write.csv(beritadetik1,'E:/Tugas Akhir/Fetch Berita/berita moneter.csv')
beritamoneter <- read.csv("E:/Tugas Akhir/Fetch Berita/berita moneter.csv")
```

```{R}
beritamoneter <- beritamoneter[,-c(1)]
```

```{r}
beritadetik <- read.csv("E:/Tugas Akhir/Fetch Berita/berita moneter 2018.csv")
...
write.csv(beritadetik1,'E:/Tugas Akhir/Fetch Berita/berita mon tri I.csv')
write.csv(beritadetik2,'E:/Tugas Akhir/Fetch Berita/berita mon tri II.csv')
write.csv(beritadetik3,'E:/Tugas Akhir/Fetch Berita/berita mon tri III.csv')
write.csv(beritadetik4,'E:/Tugas Akhir/Fetch Berita/berita mon tri IV.csv')
```
