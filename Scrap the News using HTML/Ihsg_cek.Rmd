...
```{r}
daftarpages <- c(ceiling(1378/9),ceiling(11/9),ceiling(1)) #Jumlah pages
daftarurl <-c(
  'https://www.detik.com/search/searchall?query=ihsg&siteid=29&sortby=time&fromdatex=01/01/2018&todatex=31/12/2018&page=',
  'https://www.detik.com/search/searchall?query=ihsg&siteid=3&sortby=time&fromdatex=01/01/2018&todatex=31/12/2018&page=',
  'https://www.detik.com/search/searchall?query=ihsg&siteid=5&sortby=time&fromdatex=01/01/2018&todatex=31/12/2018&page=')

#daftarpages <- c(as.integer(1378/9),as.integer(11/9),1) # Jumlah pages
...
```{r}
beritaihsg <-fetchberita(listurls)
```

```{R}
write.csv(beritaihsg,'E:/Tugas Akhir/Fetch Berita/dataihsg.csv')
beritadetik <- read.csv("E:/Tugas Akhir/Fetch Berita/dataihsg.csv")
```

nambah data
```{R}
write.csv(beritaihsg,'E:/Tugas Akhir/Fetch Berita/dataihsgnew.csv')
beritadetik <- read.csv("E:/Tugas Akhir/Fetch Berita/dataihsgnew.csv")
```
...
x <- data.frame(topik=rep("ihsg", nrow(beritadetik)))
...
nambah data
```{r}
beritaihsg <- read.csv("E:/Tugas Akhir/Fetch Berita/berita ihsg.csv")
#beritaihsg <- beritaihsg[,-c(1:2)]
beritaihsg <- rbind(beritaihsg,beritadetik)
write.csv(beritaihsg,'E:/Tugas Akhir/Data Edit/berita ihsg.csv')
beritaihsg <- read.csv("E:/Tugas Akhir/Data Edit/berita ihsg.csv")
```

```{R}
write.csv(beritadetik,'E:/Tugas Akhir/Fetch Berita/berita ihsg 2018.csv')
write.csv(beritadetik1,'E:/Tugas Akhir/Fetch Berita/berita ihsg.csv')
beritaihsg <- read.csv("E:/Tugas Akhir/Fetch Berita/berita ihsg.csv")
```

```{R}
beritaihsg <- beritaihsg[,-c(1)]
```

```{r}
beritadetik <- read.csv("E:/Tugas Akhir/Fetch Berita/berita ihsg 2018.csv")
...
write.csv(beritadetik1,'E:/Tugas Akhir/Fetch Berita/berita ihsg tri I.csv')
write.csv(beritadetik2,'E:/Tugas Akhir/Fetch Berita/berita ihsg tri II.csv')
write.csv(beritadetik3,'E:/Tugas Akhir/Fetch Berita/berita ihsg tri III.csv')
write.csv(beritadetik4,'E:/Tugas Akhir/Fetch Berita/berita ihsg tri IV.csv')
```
