...
ubah
```{r}
daftarpages <- c(ceiling(46/9)) #Jumlah pages
daftarurl <-c(
  'https://www.detik.com/search/searchall?query=market%20research&siteid=29&sortby=time&fromdatex=01/07/2018&todatex=31/12/2018&page=')
...
ubah
```{r}
beritamarketr <-fetchberita(listurls)
```
ubah
```{R}
write.csv(beritamarketr,'E:/Tugas Akhir/berita diambil/datamarketr.csv')
beritadetik <- read.csv("E:/Tugas Akhir/berita diambil/datamarketr.csv")
```
...
x <- data.frame(topik=rep("market research", nrow(beritadetik)))
beritadetik <- cbind(beritadetik,x)
beritadetik <- beritadetik[beritadetik$tahun>2017,]
```
ubah
```{R}
write.csv(beritadetik,'E:/Tugas Akhir/berita diambil/berita market research.csv')
```
ubah
```{r}
beritadetik <- read.csv("E:/Tugas Akhir/berita diambil/berita market research.csv")
...
write.csv(beritadetik1,'E:/Tugas Akhir/berita diambil/berita market research tri III.csv')
write.csv(beritadetik2,'E:/Tugas Akhir/berita diambil/berita market research tri IV.csv')
```