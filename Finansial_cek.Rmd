...
```{r}
daftarpages <- c(ceiling(297/9),ceiling(353/9),ceiling(118/9)) #Jumlah pages
daftarurl <-c(
  'https://www.detik.com/search/searchall?query=finansial&siteid=29&sortby=time&fromdatex=01/01/2018&todatex=31/12/2018&page=',
  'https://www.detik.com/search/searchall?query=finansial&siteid=3&sortby=time&fromdatex=01/01/2018&todatex=31/12/2018&page=',
  'https://www.detik.com/search/searchall?query=finansial&siteid=5&sortby=time&fromdatex=01/01/2018&todatex=31/12/2018&page=')
...
```{r}
beritafinance <- fetchberita(listurls)
```

```{R}
write.csv(beritafinance,'E:/Tugas Akhir/Fetch Berita/datafinansial.csv')
beritadetik <- read.csv("E:/Tugas Akhir/Fetch Berita/datafinansial.csv")
```

nambah data
```{R}
write.csv(beritafinance,'E:/Tugas Akhir/Fetch Berita/datafinansialnew.csv')
beritadetik <- read.csv("E:/Tugas Akhir/Fetch Berita/datafinansialnew.csv")
```
...
x <- data.frame(topik=rep("finansial", nrow(beritadetik)))
...
```{R}
write.csv(beritadetik,'E:/Tugas Akhir/Fetch Berita/berita finansial 2018.csv')
write.csv(beritadetik1,'E:/Tugas Akhir/Fetch Berita/berita finansial.csv')
beritafin <- read.csv("E:/Tugas Akhir/Fetch Berita/berita finansial.csv")
```

```{R}
beritafin <- beritafin[,-c(1)]
```

```{r}
beritadetik <- read.csv("E:/Tugas Akhir/Fetch Berita/berita finansial 2018.csv")
...
write.csv(beritadetik1,'E:/Tugas Akhir/Fetch Berita/berita fin tri I.csv')
write.csv(beritadetik2,'E:/Tugas Akhir/Fetch Berita/berita fin tri II.csv')
write.csv(beritadetik3,'E:/Tugas Akhir/Fetch Berita/berita fin tri III.csv')
write.csv(beritadetik4,'E:/Tugas Akhir/Fetch Berita/berita fin tri IV.csv')
```
